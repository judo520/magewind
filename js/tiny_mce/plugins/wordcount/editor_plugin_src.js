...
(function() {
	tinymce.create('tinymce.plugins.WordCount', {
		...
		init : function(ed, url) {
			...
			t.countre = ed.getParam('wordcount_countregex', /[\w\u2019\u00c0-\u00ff^\uc397^u00f7\'-]+/g); // u2019 == &rsquo; u00c0-u00ff extended latin chars with diacritical marks. exclude uc397 multiplication & u00f7 division
